...
//     quantity: '',
//     measure_unit: '',
//     expiry_date: '', // Added expiry_date field
//   });
//   const [editIndex, setEditIndex] = useState(null);
//   const [searchTerm, setSearchTerm] = useState('');
//   const [showError, setShowError] = useState(false);
...
//       quantity: '',
//       measure_unit: '',
//       expiry_date: '', // Reset expiry_date field
//     });
//     setEditIndex(null);
//     setShowError(false);
//   };
...
//   const handleSubmit = (event) => {
//     event.preventDefault();
//     const { id, name, category_id, price, quantity, measure_unit, expiry_date } = newProduct;

//     // Check if all fields are filled
//     if (!id || !name || !category_id || !price || !quantity || !measure_unit || !expiry_date) {
//       setShowError(true);
//       return;
//     }
